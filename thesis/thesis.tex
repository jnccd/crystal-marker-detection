...
\begin{table}
  \begin{tabular}{ c c }
   Approach & Sinkhorn Loss \\ 
   \hline
   MobilenetV2 with custom 2 linear layer head & 469.87 \\
   MobilenetV2 with custom 3 linear layer head & 454.20 \\
   VGG16 with custom head & 470.69 \\
   Harris corner interpretation of U-Net masks & 382.75 \\
   \hline
  \end{tabular}
  \caption{\label{tab:pet_valdata_results}Results of Sinkhorn loss comparison on validation data for different point detection approaches}
\end{table}
