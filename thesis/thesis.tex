...
For now the different approaches only output points. However to detect how the marker lies in 3D space, it is also nessecary to sort the points based on the rotation of the marker. 
