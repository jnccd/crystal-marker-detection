...
Since a minimal approach did not lead to satisfactory results, I switched to using a U-Net. Except for changing the loss to dice loss for the segmentation masks, the rest of the approach stayed the same. The same albumentations augmentations used above also work on segmentation masks. 
