...
\begin{figure}
  ...
  \caption{An example for label move v2, in which the label is moved from the middle to the bottom left and despite the background color differences is not as noticeable}
