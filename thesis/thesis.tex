...
The first part of the script pipeline serves four major goals. 
...
Thirdly, it should output a range of dataset types such that the data can be easily trained on many predefined \ac{NN} packages and projects to get the best results. This is addressed by the \texttt{create\_dataset} script seen in \figureref{fig:arch_data} which builds the data in a variety of dataset structures.
