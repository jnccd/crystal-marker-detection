...
Of the available inference parameters I mainly used \ac{SAHI} in the tests, since the markers in the testset were small and \ac{SAHI} incrased the \ac{mAP} score in initial tests.
