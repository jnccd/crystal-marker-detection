...
\subsubsection{Hough Lines Based Mask Interpretation}
...
\begin{table}
  \begin{tabular}{ c c c }
   ...
   Hough lines based interpretation of U-Net masks & 6.36 & 36.83 \\
   \hline
  \end{tabular}
  \caption{\label{tab:pet_valdata_results}Comparison of lowewst achieved Sinkhorn loss and mean point distance on validation data for different point detection approaches}
\end{table}
