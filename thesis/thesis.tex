...
\begin{lstlisting}[caption={Inner Rectangle Finding},captionpos=b,label=lst:irf]
...
This section describes the augmentations that were implemented into the \texttt{create\_dataset} script. They were implemented such that the chance of their usage can be set through the command line arguments. 
