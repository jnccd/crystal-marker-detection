...
The run achieved a Pascal VOC 2010 \ac{mAP} score of 70.78\%.
...
Based on the findings of Terven et al. \cite{terven2023comprehensive}, \ac{YOLO}v7 models may be promising since they achieved a better score with them than with \ac{YOLO}v5. However, the COCO \ac{mAP} score difference was 1\%.
