...
The first part of the script pipeline serves three major goals. Firstly it should define a standardized label data type, secondly it should allow for a simple way to annotate large amounts of data to keep the labeling workload low and thirdly it should output a range of dataset types such that the data can be easily trained on many predefined \ac{NN} packages and projects to get the best results.
