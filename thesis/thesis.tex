...
To validate that a neural network based approach is necessary in this case, I tested some approaches using algorithms from \ac{OpenCV}, that do not require machine learning. For these tests I chose a base image from the given data, on which the markers were facing the camera and had as much visible contours as possible, which can be seen in \autoref{fig:classic_base_img}. 

\begin{figure}
  \caption{Base Image for Classic Approaches}
