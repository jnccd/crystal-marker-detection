...
On the final testset, the best fitted yolov5s model created during the hyper parameter optimization on \texttt{gpv2} scores \acp{mAP} of 49.13\% on VOC 2010 and 26.4\% on COCO. The best fitted yolov5x model from the hyperparameter optimization for the server based approach scores \acp{mAP} of 53.04\% on VOC 2010 and 33.4\% on COCO.
