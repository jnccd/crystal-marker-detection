...
% TODO?: \section{Classic approaches}
...
Once the user is done the labels are transferred to each other image by finding the aruco frame like before, finding its inner rectangle, computing the homography for it and transforming the user defined labels as polygons onto the image. However this time the homography is computed from the points $(0,h), (0,0), (w,0), (w,h)$ to the inner rect corners.
