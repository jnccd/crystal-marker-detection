...
Based on the findings of Treven et al. \cite{terven2023comprehensive}, \ac{YOLO}v7 models may be promising. However in their findings \ac{YOLO}v7 only achieved a COCO \ac{mAP} score that was 1\% higher than the one they got using \ac{YOLO}v5.
