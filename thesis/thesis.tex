...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/zero-based-sgs-ensemble-2-thesis}
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/zero-based-sgs-sahi-ensemble-2-thesis}
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/zero-based-rot-ensemble-2-thesis}
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/zero-based-rc2-ensemble-2-thesis}
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/hyp-based-rc2-sahi-ensemble-2-thesis}
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{image/hyp-based-sgs-sahi-ensemble-2-thesis}
