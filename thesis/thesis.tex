...
In the following paragraphs the \ac{mAP} calculation is shown using the example shown in \figureref{fig:preds}. The first parts of the \ac{mAP} calculation are the same across all scores shown here.
