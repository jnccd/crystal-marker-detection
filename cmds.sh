...
python batch_train/yolov5.py -d /data/pcmd/dataset/yolov5-640-best-yolov5s-hyp-search-set/ -t /data/pcmd/dataset/yolov5-640-on-skin-valset-v3-ensemble-test/ -e 368 -snr -rsf -o /data/pcmd/training/test-yolov5-with-foremasks
