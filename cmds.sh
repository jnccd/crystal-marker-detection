...
python batch_train/yolo_nas.py -e 2 -d traindata-creator/dataset/yolov5-640-best-yolov5s-hyp-search-set -rsf -t traindata-creator/dataset/yolov5-0-on-skin-valset-v3-ensemble-test/
python batch_train/yolo_nas.py -e 2 -d /data/pcmd/dataset/yolov5-640-best-yolov5s-hyp-search-set -rsf -t /data/pcmd/dataset/yolov5-0-on-skin-valset-v3-ensemble-test/
