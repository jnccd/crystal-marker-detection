...
for dir in dataset_dirs[:1]:
    os.system(f'python repos/yolov5_train_loop.py -n {dir.stem}-1 -d {dir} -v {valset_path} -e 300 --no-aug')
    os.system(f'python repos/yolov5_train_loop.py -n {dir.stem}-2 -d {dir} -v {valset_path} -e 300 --no-aug')
    os.system(f'python repos/yolov5_train_loop.py -n {dir.stem}-3 -d {dir} -v {valset_path} -e 300 --no-aug')
