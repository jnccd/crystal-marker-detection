...
def random_crop_v2(img: Mat, polys: List[Polygon], target_size_wh: tuple, min_size_wh: tuple = (320, 320)):
    ...
    crop_pos_x = random.randrange(0, img.shape[1] - max(min_size_wh[0], int(min_size_wh[1] * target_size_ratio)))
    ...
    crop_width = random.randrange(min_size_crop_width, max_size_crop_width) if min_size_crop_width < max_size_crop_width else min_size_crop_width
